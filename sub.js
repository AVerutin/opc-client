...
const sqlCreateTable = "CREATE TABLE IF NOT EXISTS Nodes (ID INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, Name TEXT NOT NULL, Value numeric NOT NULL);";
